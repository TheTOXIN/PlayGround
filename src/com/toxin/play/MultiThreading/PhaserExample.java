...
/**
 * int register() — регистрирует нового участника, который выполняет фазы.
 * Возвращает номер текущей фазы;
 * <p>
 * int getPhase() — возвращает номер текущей фазы;
 * <p>
 * int arriveAndAwaitAdvance() — указывает что поток завершил выполнение фазы.
 * Поток приостанавливается до момента, пока все остальные стороны не закончат выполнять данную фазу. Точный аналог CyclicBarrier.await().
 * Возвращает номер текущей фазы;
 * <p>
 ...
 * Возвращает номер текущей фазы;
 * <p>
 * int awaitAdvance(int phase) — если phase равно номеру текущей фазы, приостанавливает вызвавший его поток до её окончания.
 * В противном случае сразу возвращает аргумент.
 */
